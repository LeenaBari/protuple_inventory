...
def create_db():
    ...
    cur=con.cursor()
    cur.execute("CREATE TABLE IF NOT EXISTS employee(eid INTEGER PRIMARY KEY AUTOINCREMENT,name text,email text,gender text,contact text,dob INTEGER,doj text,pass text,utype text,address text,salary text)")
    con.commit()
